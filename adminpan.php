...
<div class="adminbody">    
     ...
     <div id="left_block">
       <span class="blk1_lp"> <span class="our">ADMIN</span>     
  	  ...
  	  <br /><br /> <br /><br />
       <ul id="sbar">
      <li style=" background:#FC3; color:#FFF; font:25px 'Arial Black', Gadget, sans-serif">QUICK LINK</li>
      <?php session_start();
	  if(isset($_SESSION['Astatus']))
	  	if( $_SESSION['Astatus']=="admin"){
	  	echo'<br> <li> <a href="#">Employee maintenance</a></li>';
		}
	  ?>
      <br />
      ...
      <span><img src="images/tods-sneakers-man-desktop.jpg" height="180" width="300" />
      <br />
      </span>
     </div>
 	 ...
 	 <div id="mid"> 
     	<div id="midl">
        	<h1 align="center" style="font:30px Trebuchet MS; color:#FFF; text-shadow:1px 1px 120px blue; display:block;">
            	<u>Admin Panel</u>
            </h1>
		 <span id="smap">
		  ...
		  if(isset($_SESSION['Astatus']))
			if( $_SESSION['Astatus']=="admin"){
			echo'<a href="#">Employee List</a>
           <br /><br />';
			}
		  ?>
           <a href="#">Users List</a>
           <br /> <br /> 
           <a href="#">Available Goods</a><br /> <br />
           
		<?php
		if(isset($_SESSION['Astatus']))
	  	if( $_SESSION['Astatus']=="admin"){
	  	echo'<a href="addadmin.php">Add An Employee</a><br /><br />';
		}
		?>
           <a href="#">Edit User</a><br> <br />
           <a href="#">Remove A User<br> <br />
           <a href="#"><font color="#CC3366">Short down Site</font></a>
         </span> 
 
        <span id="smap2"><br /><br />
          <a href="new.php">Add New Product</a><br /> <br /> 
          <a href="#">Site Blog</a><br /> <br />
          <a href="#">Request List</a><br /><br />
          <a href="#">Refund Payment</a><br> <br />
